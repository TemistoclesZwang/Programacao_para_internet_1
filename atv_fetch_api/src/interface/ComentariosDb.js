...
var ComentariosDb = /** @class */ (function () {
    ...
    ComentariosDb.prototype.create = function (comentario) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    query_2 = "INSERT INTO Comentarios (comentario, id_post) VALUES (?, ?)";
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            _this.db.run(query_2, [comentario.text, comentario.id_post], function (err) {
                                if (err) {
    ...
    ComentariosDb.prototype.retrieveAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    query_3 = "SELECT * FROM Comentarios";
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            _this.db.all(query_3, function (err, rows) {
                                if (err) {
